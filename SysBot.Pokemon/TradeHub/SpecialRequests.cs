...
namespace SysBot.Pokemon
{
    public static class SpecialRequests
    {
        ...
        public static SpecialTradeType CheckItemRequest<T>(ref T pk, PokeRoutineExecutor<T> caller, PokeTradeDetail<T> detail, string TrainerName, SAV8SWSH sav) where T : PKM, new()
        {
        ...
        private static T? LoadEvent<T>(string v, SAV8SWSH sav) where T : PKM, new()
        {
            T? toRet = null;
            byte[] wc = new byte[1];
            string type = "fail";
